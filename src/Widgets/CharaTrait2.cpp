...
CharaTrait2::CharaTrait2( QWidget* parent, cv_Trait* trait, cv_Trait* traitStorage ) : TraitLine( parent, trait->name, trait->value ) {
...
void CharaTrait2::checkTraitPrerequisites( cv_Trait* trait ) {
...
void CharaTrait2::updateWidget( cv_Trait* trait ) {
	if ( traitPtr() == trait ) {
